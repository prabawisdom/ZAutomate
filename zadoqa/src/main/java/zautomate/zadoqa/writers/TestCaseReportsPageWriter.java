...
import zautomate.zadoqa.enums.Colors;
import zautomate.zadoqa.enums.ExceptionDetails;
...
import zautomate.zadoqa.utils.Steps;
import zautomate.zadoqa.utils.TestParameters;
import zautomate.zadoqa.utils.Utils;
...
public class TestCaseReportsPageWriter extends ReportsPage {
	...
	public static void failureLog(String testcaseName,String failureReason,String detailStackTrace) {
		String currenttime = new SimpleDateFormat("EyyyyMMddHHmmssa").format(Calendar.getInstance().getTime());
		File filePath = new File(Directory.Reports_Path+"/logs"); 
		filePath.mkdir();
		fileName = filePath+"/Failure_Log- "+currenttime+".log";
		try(FileWriter fw = new FileWriter(fileName, true);
				BufferedWriter bw = new BufferedWriter(fw);
				PrintWriter out = new PrintWriter(bw))
		{

			out.println("Testcase Name "+testcaseCount+":"+testcaseName);
			out.flush();
